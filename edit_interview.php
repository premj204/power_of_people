                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <select id="category" name="category" class="form-select">
                                        ...
                                        <option value="Power Of Words"
                                            <?php if($interview[0]['category'] == 'Power Of Words'){ echo "selected";} ?>>
                                            Power Of Words
                                        </option>
                                        <option value="Power Of Action"
                                            <?php if($interview[0]['category'] == 'Power Of Action'){ echo "selected"; } ?>>
                                            Power Of Action
                                        </option>
                                        <option value="Power Of Charity"
                                            <?php if($interview[0]['category'] == 'Power Of Charity'){ echo "selected"; } ?>>
                                            Power Of Charity</option>

                                            <option value="Power Of Life Work's"
                                            <?php if($interview[0]['category'] == 'Power Of Life Works'){ echo "selected"; } ?>>
                                            Power Of Life Works</option>

                                            <option value="Power Of Health"
                                            <?php if($interview[0]['category'] == 'Power Of Health'){ echo "selected"; } ?>>
