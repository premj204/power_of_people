            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-12 col-xs-12 footer-widget widget-categories">
                    ...
                    <ul>
                        ...
                        <li><i class="fa fa-angle-double-right"></i><a href="#"><span
                                    class="catTitle">Interview</span><span class="catCounter"> (25)</span></a>
                        </li>
                        <li><i class="fa fa-angle-double-right"></i><a href="#"><span
                                    class="catTitle">Author</span><span class="catCounter"> (05)</span></a>
                        </li>
                        <li><i class="fa fa-angle-double-right"></i><a href="#"><span
                                    class="catTitle">Health Care</span><span class="catCounter"> (12)</span></a>
                        </li>
                        <li><i class="fa fa-angle-double-right"></i><a href="#"><span class="catTitle">LifeStyle</span><span
